...
document.addEventListener("DOMContentLoaded", function () {
    const scriptURL = "https://script.google.com/macros/s/AKfycbwgs0YuAK9BLpdA4gPCCh-TC0WZjqu8NOtnOhsOERXvNO_h0M3pjmO41xwV-GYh2cLi/exec"; // ✅ Replace with your script URL
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            const response = await fetch(scriptURL, {
                method: "POST",
                body: new URLSearchParams(formObject) // ✅ Correct encoding for Google Apps Script
            });
